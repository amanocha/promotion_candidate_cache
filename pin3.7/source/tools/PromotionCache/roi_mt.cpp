...
static VOID RecordMem(VOID * ip, CHAR r, VOID * addr, INT32 size, BOOL isPrefetch, THREADID tid)
{
    ...
    */
    ...
    pcc_track_access((uint64_t) addr, tid);
}
...
int main(int argc, char *argv[])
{
    ...
    cout << "THREADS = " << num_threads << ", ACCESS INTERVAL = " << ACCESS_INTERVAL << ", PROMOTION CACHE SIZE = " << PROMOTION_CACHE_SIZE << ", FACTOR = " << FACTOR << endl;
